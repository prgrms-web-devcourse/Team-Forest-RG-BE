...
date_add(now(), interval 5 day), '자전거가 타고싶어요', 5, 2, 3, 'IN_PROGRESS');
...
date_add(now(), interval 5 day), '자전거 타실 분.', 5, 2, 2, 'IN_PROGRESS');
...
date_add(now(), interval 5 day), '자전거 타요!!!!', 5, 2, 2, 'IN_PROGRESS');
...
date_add(now(), interval 9 day), '자전거 타요!!!!', 5, 2, 2, 'IN_PROGRESS');
...
date_add(now(), interval 5 day), '자전거 gogo', 5, 2, 1, 'IN_PROGRESS');
