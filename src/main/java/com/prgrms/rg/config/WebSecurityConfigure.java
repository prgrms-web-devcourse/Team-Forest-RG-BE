...
public class WebSecurityConfigure extends WebSecurityConfigurerAdapter {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOriginPatterns(List.of("https://cool-dusk-ced14a.netlify.app","http://211.201.93.105:[*]","http://124.50.252.111:[*]","http://211.226.115.222:[*]","http://localhost:[*]"));
